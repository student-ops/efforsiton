    ...
    return (
        <form
            ...
            <div className="p-4 w-full text-gray-800 border border-gray-300  shadow-lg">
                ...
                />
                <textarea
                    className="w-full bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none"
                    spellCheck="false"
                ...
                <div className="buttons flex mt-3">
                    ...
                    <button
                        type="submit"
                        className="border border-indigo-500 p-1 px-4 font-semibold
                        cursor-pointer text-gray-200 ml-auto bg-indigo-500">
                        Submit
                    </button>
                </div>
            </div>
